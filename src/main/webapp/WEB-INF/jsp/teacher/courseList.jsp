                        ...
                        <nav style="text-align: center">
                            <ul class="pagination">
                                ...
                                <c:if test="${pageBean.currentPage+1 <= pageBean.totalPage}">
                                    <li>
                                        <a href="${pageContext.request.getContextPath()}/teacher/course_list/${pageBean.currentPage+1}">${pageBean.currentPage+1}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pageBean.currentPage+2 <= pageBean.totalPage}">
                                    <li>
                                        <a href="${pageContext.request.getContextPath()}/teacher/course_list/${pageBean.currentPage+2}">${pageBean.currentPage+2}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pageBean.currentPage+3 <= pageBean.totalPage}">
                                    <li>
                                        <a href="${pageContext.request.getContextPath()}/teacher/course_list/${pageBean.currentPage+3}">${pageBean.currentPage+3}</a>
                                    </li>
                                </c:if>
