...
<head>
    ...
    <style type="text/css">
        body {
            background: url(${pageContext.request.getContextPath()}/static/images/a.jpg) repeat;
        }
        ...
        <div class="col-md-4" id="login-box">
            <form class="form-horizontal" action="login"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" id="userID" placeholder="请输入名字" name="username">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group pull-right" style="margin-right: 15px;">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button class="btn btn-default btn-info">登录</button>
                    </div>
                </div>
            </form>
        </div>
